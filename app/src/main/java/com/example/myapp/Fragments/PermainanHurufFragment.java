...
public class PermainanHurufFragment extends Fragment {
    ...
    public PermainanHurufFragment() {
        // Required empty public constructor

        pilihan1.add(R.drawable.jawaban_huruf_1_1);
        pilihan1.add(R.drawable.jawaban_huruf_2_1);
        pilihan1.add(R.drawable.jawaban_huruf_3_1);

        pilihan2.add(R.drawable.jawaban_huruf_1_2);
        pilihan2.add(R.drawable.jawaban_huruf_2_2);
        pilihan2.add(R.drawable.jawaban_huruf_3_2);

        kunci.add(1);
        kunci.add(2);
        kunci.add(1);

        sound_soal.add(R.raw.soal_huruf_1);
        sound_soal.add(R.raw.soal_huruf_2);
        sound_soal.add(R.raw.soal_huruf_3);

        soal.add(R.drawable.soal_huruf_1);
        soal.add(R.drawable.soal_huruf_2);
        soal.add(R.drawable.soal_huruf_3);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_permainan_huruf, container, false);
